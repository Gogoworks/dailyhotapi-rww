    ...
    <Layout title="Error | DailyHot API">
      <main>
        ...
        <div class="page-header">
          <h1 class="page-title">出错了</h1>
          <p class="page-subtitle">程序执行出错，请稍后重试</p>
        </div>
        {props?.error ? <div class="page-content">{props.error}</div> : null}
        <div class="page-actions">
          <button id="reload-button" class="action-button primary" type="button">
